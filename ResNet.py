...
resnet_weights_path = 'C:/Skin/ResNet/resnet50_weights_tf_dim_ordering_tf_kernels.h5~'
...
benign_train = np.array(Dataset_loader('C:/Skin/ResNet/skin cancer archive/train/benign',224))
malign_train = np.array(Dataset_loader('C:/Skin/ResNet/skin cancer archive/train/malignant',224))
benign_test = np.array(Dataset_loader('C:/Skin/ResNet/skin cancer archive/test/benign',224))
malign_test = np.array(Dataset_loader('C:/Skin/ResNet/skin cancer archive/test/malignant',224))
